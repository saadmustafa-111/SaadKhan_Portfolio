const PricingPlans = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {plans.map((plan, index) => (
              <div
                key={index}
                className="bg-black rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300"
              >
                <div className="mb-8">
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "$150",
      features: ["✔ Up to 10 Pages", "✔ Mobile-Friendly Design", "✔ SEO Optimization","✔ Contact Form Integration"],
      buttonText: "Get Started",
    },
    {
      ...
      price: "Custom",
      features: ["✔ Unlimited Pages", "✔ Fully Responsive Design", "✔ Advanced SEO & Speed Optimization", "✔ Payment Gateway Integration","✔ Admin Dashboard"],
      buttonText: "Get Started",
    },
  ];
